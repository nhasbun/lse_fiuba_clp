...
# ACDS 21.1 850 linux 2022.10.11.00:11:57
...
TOP_LEVEL_NAME="pll_clk"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/home/nhasbun/intelFPGA_lite/21.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_clk.vho"
fi
